(function() {
  ...
  Backbone.lang = {
    ...
    dict: {
      ...
      city: ['City', 'Ville'],
      state: ['State or province', 'Province ou État'],
      zip: ['Zip or postal code', 'Code postal ou zip'],
      country: ['Counrty', 'Pays'],
      ...
      voicephone: ['Home phone', 'Téléphone à la maison'],
      mobilephone: ['Mobile phone', 'Téléphone mobile'],
      ...
      currentProgram: ['Current program', 'Programmation en cours'],
      upcomingProgram: ['Upcoming program', 'Programmation à venir'],
      lastProgram: ['Last program', 'Programmation passée'],
